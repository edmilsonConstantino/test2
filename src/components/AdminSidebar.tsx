    ...
    <>
      ...
      >
        ...
        <div className="shrink-0 pt-2 border-t border-slate-100 flex flex-col gap-2.5 bg-white">
          ...
          <div className="p-3 rounded-2xl bg-[#1455AC]/5 border border-slate-200 relative overflow-hidden flex flex-col items-center text-center shadow-2xs">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-slate-50 hover:bg-[#1455AC]/10 border border-slate-200 hover:border-[#1455AC]/30 text-slate-700 hover:text-[#1455AC] font-bold rounded-xl py-2 px-3 text-[11.5px] transition-colors cursor-pointer"
          >
