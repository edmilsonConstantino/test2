...
export const AcessoRestritoAdminView: React.FC<AcessoRestritoAdminViewProps> = ({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 font-sans">
      <div className="bg-white rounded-xl border border-slate-200 shadow-2xs p-6 sm:p-10 relative overflow-hidden font-sans">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center space-y-6 font-sans">
          ...
          <div className="inline-flex items-center justify-center font-sans">
            <div className="relative">
              <div className="w-20 h-20 rounded-xl bg-rose-50 border border-rose-200 text-rose-600 flex items-center justify-center shadow-2xs">
          ...
          <div className="space-y-2 font-sans">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-50 text-rose-700 border border-rose-200 text-xs font-bold uppercase tracking-wider font-sans">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 max-w-md mx-auto text-left shadow-2xs font-sans">
            ...
            {attemptedTab && (
              <div className="mt-3 pt-3 border-t border-slate-200 text-[11px] text-slate-500 flex items-center justify-between font-sans">
                <span>Rota solicitada:</span>
                <code className="bg-slate-200 text-slate-800 px-1.5 py-0.5 rounded font-mono text-[10px]">
                  #{attemptedTab}
                </code>
              </div>
            )}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2 font-sans">
            ...
            {onSwitchToAdmin && (
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl text-xs font-bold text-slate-700 bg-white hover:bg-slate-50 border border-slate-200 transition-all cursor-pointer font-sans"
              >
