    ...
    >
      ...
      >
        ...
        <div className="text-center flex flex-col items-center shrink-0">
          ...
          <h3 className="text-xl font-extrabold text-slate-900 font-sans mt-2.5">
        ...
        {submitted ? (
          <div className="py-8 text-center space-y-2">
            ...
            <h4 className="text-sm font-bold text-slate-900">Autenticado com sucesso!</h4>
          ...
          <div className="flex flex-col flex-1 min-h-0">
            ...
            <div className="flex items-center gap-1 p-1 bg-slate-50 border border-slate-200/80 rounded-xl mb-3.5 text-xs shrink-0">
              <button
                type="button"
                ...
                className={`flex-1 py-1.5 px-3 rounded-lg flex items-center justify-center gap-2 transition-all cursor-pointer ${
                  loginMethod === 'demo'
                    ? 'bg-white text-[#1455AC] shadow-2xs font-bold border border-slate-200/80'
                    : 'text-slate-600 hover:text-slate-900 font-medium'
                }`}
              >
                <Sparkles className="w-3.5 h-3.5 text-[#1455AC] shrink-0" />
                <span>Perfis Demo</span>
                <span className="text-[10px] font-black px-1.5 py-0.2 rounded-full bg-[#1455AC]/10 text-[#1455AC] border border-[#1455AC]/20">
                  5 Perfis
                </span>
              </button>
              <button
                    ...
                    return (
                      <button
                        ...
                        className={`w-full p-2.5 sm:p-3 rounded-xl text-left transition-all flex items-center justify-between gap-3 cursor-pointer group border ${
                          isSelected
                            ? 'bg-[#1455AC]/5 border-[#1455AC] shadow-2xs ring-1 ring-[#1455AC]/30'
                      ...
                      >
                        ...
                        <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-100 group-hover:bg-[#1455AC] text-slate-600 group-hover:text-white font-bold text-[11px] transition-all">
                          <span>Entrar</span>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 text-xs bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-[#1455AC] text-slate-900"
                    />
                  </div>
                </div>
