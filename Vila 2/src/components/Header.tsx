...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      id="main-top-header"
      className="sticky top-0 z-30 w-full bg-white border-b border-slate-200 px-4 md:px-8 py-3.5 flex items-center justify-between gap-4 shadow-2xs"
    >
      ...
      <div className="flex-1 max-w-2xl mx-auto">
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-2.5 bg-[#F8FAFC] hover:bg-slate-100 border border-slate-200 rounded-2xl text-sm text-[#94A3B8] transition-all group shadow-2xs hover:border-[#1455AC]/40 cursor-pointer"
        >
          <div className="flex items-center gap-3 min-w-0">
            <Search className="w-4 h-4 text-slate-400 group-hover:text-[#1455AC] transition-colors shrink-0" />
      ...
      <div className="flex items-center gap-3 md:gap-4 shrink-0">
        ...
        <div className="relative">
          ...
          {showLangMenu && (
            <div className="absolute right-0 mt-2 w-36 bg-white border border-slate-200 rounded-xl shadow-lg py-1.5 z-40">
              <button
        ...
        <div className="relative">
          <button
            ...
            className="relative p-2 rounded-xl text-slate-700 hover:bg-[#1455AC]/10 hover:text-[#1455AC] transition-colors cursor-pointer"
            aria-label="Notificações"
          >
            <Bell className="w-5 h-5" />
            <span
              id="header-notification-badge"
              className="absolute top-1 right-1 flex items-center justify-center min-w-[17px] h-[17px] px-1 text-[9.5px] font-bold text-white bg-[#F58300] rounded-full ring-2 ring-white"
            >
              3
            </span>
          </button>
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-2 w-80 md:w-96 bg-white border border-slate-200 rounded-2xl shadow-xl z-50 overflow-hidden">
              ...
              <div className="p-2.5 text-center border-t border-slate-200 bg-slate-50">
                <button
