  ...
  return (
    <div className="w-full space-y-6 animate-in fade-in duration-150">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch font-sans">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 sm:p-6 shadow-2xs flex flex-col justify-between font-sans">
          <div>
            <h2 className="text-base font-bold text-slate-900 font-sans mb-5">
            ...
            <div className="flex items-start gap-4 font-sans">
              ...
              <div className="relative shrink-0">
                ...
                <button
                  ...
                  className="absolute bottom-0 right-0 p-1.5 bg-white rounded-full border border-slate-200 shadow-sm text-slate-600 hover:text-[#1455AC] hover:bg-slate-50 transition-colors cursor-pointer"
                >
              ...
              <div className="flex-1 min-w-0 space-y-2 font-sans">
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-900 mt-0.5 truncate font-sans">{userInfo.name}</p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap mt-0.5 font-sans">
                    <span className="text-xs font-medium text-slate-700 truncate font-sans">
                      {userInfo.email}
                    </span>
                    <span className="bg-emerald-50 text-emerald-700 text-[10px] font-semibold px-2 py-0.5 rounded-md border border-emerald-200/60 font-sans">
                      Verificado
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs font-medium text-slate-700 mt-0.5 font-sans">{userInfo.role}</p>
                </div>

                <div>
                  <p className="text-[11px] font-medium text-slate-400 leading-none">Membro desde</p>
                  <p className="text-xs font-medium text-slate-700 mt-0.5 font-sans">{userInfo.memberSince}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full mt-6 py-2.5 px-4 rounded-xl border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-2xs font-sans"
          >
          ...
          <div>
            ...
            <div className="space-y-3 font-sans">
              ...
              <div
                ...
                className="p-3 rounded-xl border border-slate-100 hover:border-slate-200 bg-slate-50/40 hover:bg-slate-50/90 transition-colors flex items-center justify-between gap-3 cursor-pointer group font-sans"
              >
                <div className="flex items-center gap-3 min-w-0 font-sans">
                  ...
                  <div className="min-w-0 font-sans">
                    <h3 className="text-xs font-bold text-slate-900 group-hover:text-[#1455AC] transition-colors font-sans">
                      E-mail e palavra-passe
                    </h3>
                    <p className="text-[11px] text-slate-500 truncate font-sans">{userInfo.email}</p>
                  </div>
                </div>
                <div className="flex items-center gap-1.5 shrink-0 font-sans">
                  <span className="bg-emerald-50 text-emerald-700 text-[10px] font-semibold px-2 py-0.5 rounded-full border border-emerald-200/60 font-sans">
                    Ativo
                  </span>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 sm:p-6 shadow-2xs flex flex-col justify-between font-sans">
          <div>
            <h2 className="text-base font-bold text-slate-900 font-sans">Contas conectadas</h2>
            <p className="text-xs text-slate-500 mt-0.5 mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start font-sans">
        ...
        <div className="lg:col-span-7 bg-white rounded-xl border border-slate-200 p-5 sm:p-6 shadow-2xs font-sans">
          <h2 className="text-base font-bold text-slate-900 font-sans">Gestão de acessos</h2>
          ...
          <div className="divide-y divide-slate-100 font-sans">
            {teamMembers.map((member) => (
              <div
                key={member.id}
                className="py-3.5 flex items-center justify-between gap-3 hover:bg-slate-50/50 rounded-xl px-2 -mx-2 transition-colors font-sans"
              >
                <div className="flex items-center gap-3 min-w-0 font-sans">
                  <img
                    src={member.avatar}
                  ...
                  <div className="min-w-0 font-sans">
                    <div className="flex items-center gap-2 flex-wrap">
                      <h3 className="text-xs font-bold text-slate-900 font-sans">{member.name}</h3>
                      <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-full font-sans ${member.pillClass}`}>
                        {member.rolePill}
                      </span>
                    </div>
                    <p className="text-[11px] text-slate-500 truncate font-sans">{member.email}</p>
                  </div>
                </div>

                <div className="flex items-center gap-3 shrink-0 font-sans">
                  <div className="flex items-center gap-1.5 text-slate-600 text-xs font-medium font-sans">
          ...
          <div className="flex items-center justify-between pt-3 pb-2 border-t border-slate-100 mt-2 font-sans">
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-full bg-blue-100 text-[#1455AC] text-xs font-bold flex items-center justify-center font-sans">
                +3
              </div>
              <span className="text-xs font-bold text-slate-800 font-sans">Mais 3 utilizadores</span>
            </div>
            <button
              type="button"
        ...
        <div className="lg:col-span-5 space-y-6 font-sans">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 sm:p-6 shadow-2xs font-sans">
            <div className="flex items-center justify-between mb-1">
              <h2 className="text-base font-bold text-slate-900 font-sans">Sessões ativas</h2>
              <button
                type="button"
            ...
            <div className="space-y-3.5 font-sans">
              {sessions.map((sess) => {
                ...
                return (
                  <div
                    key={sess.id}
                    className="flex items-center justify-between gap-3 p-2 rounded-xl hover:bg-slate-50/50 transition-colors font-sans"
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <h3 className="text-xs font-bold text-slate-900 truncate font-sans">{sess.device}</h3>
                          {sess.isCurrent && (
                            <span className="bg-purple-100 text-purple-700 text-[10px] font-bold px-2 py-0.5 rounded-full font-sans">
                              Atual
                            </span>
                          )}
                        </div>
                        <p className="text-[11px] text-slate-500 truncate font-sans">{sess.location}</p>
                      </div>
                    </div>
                    ...
                    {!sess.isCurrent && (
                      <button
                        ...
                        className="px-3 py-1 rounded-xl border border-slate-200 text-xs font-medium text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer shrink-0 font-sans"
                      >
                        Terminar sessão
                      </button>
                    )}
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 sm:p-6 shadow-2xs font-sans">
            <div className="flex items-center justify-between mb-1">
              <h2 className="text-base font-bold text-slate-900 font-sans">Atividade da conta</h2>
              <button
                type="button"
                onClick={() => setShowAuditModal(true)}
                className="text-xs font-bold text-[#1455AC] hover:underline cursor-pointer font-sans"
            ...
            <div className="space-y-3.5 font-sans">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <h3 className="text-xs font-bold text-slate-900 font-sans">Início de sessão bem-sucedido</h3>
                  <p className="text-[11px] text-slate-400 font-sans">Lisboa, Portugal • 15 mai 2024, 10:24</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <h3 className="text-xs font-bold text-slate-900 font-sans">Palavra-passe alterada</h3>
                  <p className="text-[11px] text-slate-400 font-sans">Lisboa, Portugal • 10 mai 2024, 09:15</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <h3 className="text-xs font-bold text-slate-900 font-sans">Novo método 2FA adicionado</h3>
                  <p className="text-[11px] text-slate-400 font-sans">Lisboa, Portugal • 05 mai 2024, 16:40</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ========================================================
         ...
         ======================================================== */}
      <div className="w-full bg-blue-50/70 border border-blue-100 rounded-xl p-3.5 sm:p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs shadow-2xs font-sans">
        <div className="flex items-center gap-3">
          <div className="w-7 h-7 rounded-lg bg-blue-100/80 text-[#1455AC] flex items-center justify-center shrink-0">
            <Lock className="w-4 h-4" />
          </div>
          <p className="text-slate-700 text-xs font-medium font-sans">
            <strong className="font-bold text-slate-900">Dica de segurança:</strong> Utilize uma
      ...
      {showEditInfoModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4 font-sans">
          <div className="bg-white rounded-xl border border-slate-200 max-w-md w-full p-6 shadow-2xl space-y-4 animate-in zoom-in-95 duration-200 font-sans">
            <div className="flex items-center justify-between pb-2 border-b border-slate-100">
              <h3 className="text-base font-bold text-slate-900 font-sans">Editar Informações da Conta</h3>
              <button
                type="button"
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 text-xs rounded-xl border border-slate-200 focus:border-[#1455AC] outline-none font-sans"
                />
              </div>
              <div>
      ...
      {showAllMembersModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4 font-sans">
          <div className="bg-white rounded-xl border border-slate-200 max-w-lg w-full p-6 shadow-2xl space-y-4 animate-in zoom-in-95 duration-200 font-sans">
            <div className="flex items-center justify-between pb-2 border-b border-slate-100">
              <h3 className="text-base font-bold text-slate-900 font-sans">Todos os Utilizadores da Conta (6)</h3>
              <button
                type="button"
            ...
            <div className="divide-y divide-slate-100 max-h-80 overflow-y-auto pr-1 font-sans">
              {[...teamMembers, ...additionalMembers].map((member) => (
                <div key={member.id} className="py-2.5 flex items-center justify-between gap-3 font-sans">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    />
                    <div className="min-w-0">
                      <p className="text-xs font-bold text-slate-900 truncate font-sans">{member.name}</p>
                      <p className="text-[11px] text-slate-500 truncate font-sans">{member.email}</p>
                    </div>
                  </div>
                  <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-slate-100 text-slate-700 font-sans">
                    {member.role}
                  </span>
                </div>
              ))}
      ...
      {showAuditModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4 font-sans">
          <div className="bg-white rounded-xl border border-slate-200 max-w-lg w-full p-6 shadow-2xl space-y-4 animate-in zoom-in-95 duration-200 font-sans">
            <div className="flex items-center justify-between pb-2 border-b border-slate-100">
              <h3 className="text-base font-bold text-slate-900 font-sans">Histórico Completo de Auditoria</h3>
              <button
                type="button"
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto pr-1 text-xs font-sans">
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                <p className="font-bold text-slate-900 font-sans">Sessão iniciada via Google OAuth</p>
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                <p className="font-bold text-slate-900 font-sans">Palavra-passe mestra alterada</p>
                <p className="text-[11px] text-slate-500">IP: 194.65.12.89 • Lisboa, Portugal</p>
                <p className="text-[10px] text-slate-400 mt-0.5">10 de maio de 2024 às 09:15</p>
              </div>
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                <p className="font-bold text-slate-900 font-sans">Novo autenticador TOTP ativado</p>
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                <p className="font-bold text-slate-900 font-sans">Passkey Biométrica registada (Touch ID)</p>
