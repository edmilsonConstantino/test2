      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start font-sans">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <section className="bg-white rounded-xl border border-slate-200 p-5 sm:p-6 shadow-2xs">
            <h2 className="text-base font-bold text-slate-900 mb-5 font-sans">
                ...
                <div className="flex flex-col items-center gap-3 shrink-0">
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute bottom-0 right-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#1455AC] text-white flex items-center justify-center ring-2 ring-white hover:bg-[#0F3B77] transition-colors shadow-xs cursor-pointer"
                    >
          ...
          <section className="bg-white rounded-xl border border-slate-200 p-5 sm:p-6 shadow-2xs font-sans">
        ...
        <div className="lg:col-span-5 space-y-6 font-sans">
          ...
          <section className="bg-white rounded-xl border border-slate-200 p-5 sm:p-6 shadow-2xs font-sans">
            <div className="flex items-center justify-between mb-4 font-sans">
              ...
              <span className="inline-flex items-center gap-1 bg-emerald-50 text-emerald-700 text-[11px] font-bold px-2.5 py-0.5 rounded-full border border-emerald-200/70 font-sans">
            ...
            <div className="divide-y divide-slate-100 font-sans">
              ...
              <div className="py-3 flex items-center justify-between gap-3 font-sans">
                <div className="flex items-center gap-3 min-w-0 font-sans">
                  <div className="w-8 h-8 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center shrink-0 font-sans">
                    <Lock className="w-4 h-4" />
                  </div>
                  <div className="min-w-0 font-sans">
                    <h3 className="text-xs font-semibold text-slate-900 leading-tight font-sans">
                      Palavra-passe
                    </h3>
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg border border-slate-200 hover:border-slate-300 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer shrink-0 font-sans"
                >
                  Alterar
                </button>
              </div>
              ...
              <div className="py-3 flex items-center justify-between gap-3 font-sans">
                <div className="flex items-center gap-3 min-w-0 font-sans">
                  <div className="w-8 h-8 rounded-full bg-blue-50 text-[#1455AC] flex items-center justify-center shrink-0 font-sans">
                  ...
                  <div className="min-w-0 font-sans">
                    ...
                    <p className="text-[11px] text-emerald-600 font-semibold truncate font-sans">
                      Ativada
                    </p>
                  </div>
                </div>
          ...
          <section className="bg-white rounded-xl border border-slate-200 p-5 sm:p-6 shadow-2xs font-sans">
            ...
            <div className="divide-y divide-slate-100 font-sans">
              ...
              <button
                ...
                className="w-full py-3 flex items-center justify-between gap-3 text-left hover:bg-slate-50/80 px-2 rounded-xl transition-colors cursor-pointer group font-sans"
              >
                <div className="flex items-center gap-3 min-w-0 font-sans">
                  <div className="w-8 h-8 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center shrink-0 font-sans">
                    <Download className="w-4 h-4" />
                  </div>
                  <div className="min-w-0 font-sans">
                    <h3 className="text-xs font-semibold text-slate-900 group-hover:text-[#1455AC] transition-colors leading-tight font-sans">
                      Exportar os meus dados
                    </h3>
                    <p className="text-[11px] text-slate-500 truncate font-sans">
